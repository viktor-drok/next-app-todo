...
const MediumPriorityItem = () => {
	...
	const filteredTodos = todos.filter(todo => todo.priority === "medium");

	return (
		<div className="text-center text-[26px] font-semibold leading-normal bg-medPrior-bg w-full rounded-lg p-1">
...
export default MediumPriorityItem;
